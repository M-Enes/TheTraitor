...
public:
    /**
     * @brief Contructs the battery object.
     * If any of the parameters is below 0, then it is assumed to be 0.
     * @param v Voltage of the battery.
     * @param c Capacity of the battery.
     * @param initial Initial charge of the battery.
     */
